...
from dotenv import load_dotenv  # Nécessite le package python-dotenv
...
LOCALE_PATHS = [
    BASE_DIR / 'locale',  # Assurez-vous que ce dossier existe
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.i18n',  # Pour la gestion des langues
            ],
        },
    },
]
...
ASGI_APPLICATION = 'pong_project.asgi.application'  # Pour Channels
...
# Laissez Nginx gérer la redirection HTTP->HTTPS pour éviter les boucles
SECURE_SSL_REDIRECT = False

# Cookies uniquement envoyés via HTTPS (en production).
SESSION_COOKIE_SECURE = True
CSRF_COOKIE_SECURE = True

# HSTS (Strict-Transport-Security) - Recommandé en production (1 an)
